...
private:
    ...
    sf::Text screen_resolution, screen_resolution640x800, screen_resolution800x1000, screen_resolution960x1200,
              ...
              game_mode, hard_mode, easy_mode, color_board, back_text, save_text, normal;
    ...
    sf::Sprite block, button800x600_true, button1280x1024_true, button1920x1080_true, easy_sprite, hard_sprite, score_1, score_3, score_5, board_part,
        option_board_green, option_board_yellow, option_board_red, normal_sprite;
